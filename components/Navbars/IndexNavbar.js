...
export default function Navbar({ visible }) {
  ...
  return (
      <>
        <nav className={navClassList.join(" z-50")}>
          <AnimatePresence>
            {
                open &&(
          ...
          <div className="container z-50 mx-auto flex flex-row items-center justify-between py-3 navbar-expand-lg">
            <div className="flex items-center md:text-lg align-middle text-xs font-bold leading-relaxed text-white mr-4 py-2  cursor-pointer" onClick={isOpen}>
                  <img
                      alt="..."
                      src="/img/menu.png"
            ...
            <div className="">
              <Link href="/">
                <a
                    className="flex items-center text-white align-middle text-xs font-bold leading-relaxed py-2 "
                    href="#pablo"
                >
                  ...
                  <img
                      ...
                      className="max-w-20-px md:max-w-40-px ml-1 md:ml-4"
                  />
                </a>
              </Link>
            </div>
