  ...
  return (
      <motion.main>
          ...
          <div className="flex flex-col md:flex-row mt-32 md:mt-0 min-h-screen justify-between items-end container mx-auto">
            <div className="w-full md:w-6/12 px-4">
              ...
              <motion.p
                  ...
                  className="text-lg md:text-5xl mb-6 text-justify">If you're looking for a professional and convenient way to host your next event, consider booking a our meeting room </motion.p>
            </div>
            <motion.div
                animate={{y:0}}
                initial={{y:"100%"}}
        ...
        <section className="mt-48 md:mt-20 pb-40 relative ">
              ...
              <div className="w-10/12 md:w-6/12 lg:w-6/12 md:px-4 mr-auto ml-auto ">
                      <Parallax
                        ...
                        <div className=" flex flex-col justify-between min-h-260-px">
                          <h1 className="text-5xl w-6/12 font-bold">Rooms for every type of meeting</h1>
                          <div className="flex-row flex justify-between">
                            <p className="py-2 px-6 md:px-10 text-xl text-justify">
                              Whatever type of meeting you have in mind, our wide selection of rooms allows you to choose the perfect space and location. Whether you need a large boardroom to host an event, a private room to interview candidates or an inspiring, fully-equipped space for your training session.
                            </p>
                          </div>
                        </div>
                      </Parallax>
                    </div>
              <div className="w-full md:w-6/12 px-4 pt-20 md:pt-0">
                <Parallax
                    speed={-5}
                    easing="easeInQuad">
                  <img alt="..."
          ...
          <div className="justify-center text-white bg-black pt-6 md:pt-32 mt-24 pb-32" style={{ background: `url('/img/blackbg.png') `, backgroundColor:`#000`, backgroundSize: `cover`}}>
            <div className="container mx-auto px-4">
              <div className="flex  flex-col-reverse md:flex-row flex-wrap items-center">
                <div className="w-full md:w-6/12 px-4 pt-48 md:pt-0">
                  <Parallax
                      speed={-5}
                      easing="easeInQuad">
                    <Zoom {...section4_1_s} >
                ...
                <div className="w-10/12 md:w-6/12 lg:w-6/12 md:px-4 mr-auto ml-auto ">
                  <Parallax
                      ...
                      easing="easeInQuad">
                    <div className=" flex flex-col justify-between min-h-260-px">
                      <h1 className="text-5xl w-6/12 font-bold">Equipped for any type of meeting.</h1>
                      <div className="flex-row flex justify-between">
                        <p className="py-2 px-6 md:px-10 text-xl text-justify">
                          Everyone has different needs when it comes to meeting rooms. Let us know what equipment you require, and we’ll sort it out for you. Our receptionists will greet your guests, while our on-site team prepares your room, ensuring that everything runs smoothly.
                        </p>
                      </div>
                    </div>
                  </Parallax>
