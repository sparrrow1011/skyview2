...
export default function Restaurant({ isVisible }) {
        ...
        <section className="mt-48 md:mt-20 pb-40 relative ">
          <div className="container mx-auto">
            <div className="flex flex-wrap items-center">
                    ...
                    <div className="w-10/12 md:w-5/12  md:px-4 mr-auto ml-auto ">
                      <Parallax
                          speed={1}
                          easing="easeInQuad">
                        <img alt="..."
          ...
          <div className="justify-center bg-black pt-6 md:pt-12 pb-6 md:pb-20 mt-24" style={{ background: `url('/img/blackbg.png') `, backgroundColor:`#000`, backgroundSize: `cover`}}>
            <div className="">
              ...
              <Parallax
                  ...
                  easing="easeInQuad">
                <h6
                    className="text-5xl container md:text-6xl w-8/12 md:w-3/12 mb-1 font-semibold px-6 py-16 text-white"
                >
                  Dine with a <span className=" font-bold">Sky View</span>
                </h6>
              </Parallax>
          ...
          <div className="container mx-auto px-4 pb-8 pt-1">
            <div className=" flex flex-wrap">
              ...
              <div className="w-full md:w-6/12 ml-auto px-4 md:pr-12 pt-6 md:pt-12">
                <h1 className="font-bold text-xl">Foods</h1>
